...
final class SRPTests: XCTestCase {
    ...
    func testClientSessionProof() {
        ...
        let clientProof = SRP<Insecure.SHA1>.calculateClientProof(configuration: configuration, username: username, salt: salt, clientPublicKey: SRPKey(A), serverPublicKey: SRPKey(B), hashSharedSecret: secret, padding: configuration.sizeN)
    ...
    func testRFC5054Appendix() throws {
        ...
        let u = SRP<Insecure.SHA1>.calculateU(clientPublicKey: A.bytes.pad(to: configuration.sizeN), serverPublicKey: B.bytes.pad(to: configuration.sizeN))
    ...
    func testMozillaTestVectors() throws {
        ...
        XCTAssertEqual(SRPKey(B).hex(padding: configuration.sizeN), "")
        ...
        XCTAssertEqual(SRPKey(A).hex(padding: configuration.sizeN), "")
